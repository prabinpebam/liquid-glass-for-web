...
const INVENTORY = [
  {
    ...
    groups: [
      { label: 'Core scales', items: [
        ...
        ['Sizing', 'built', 'Control heights, icon sizes, stroke widths.'],
      ...
      { label: 'Material & motion', items: [
        ...
        ['Z-index', 'built', 'Stacking scale base → toast.'],
        ['Semantic', 'built', 'Control height/padding, focus ring defaults.'],
        ['Breakpoints', 'planned', 'Responsive thresholds + container queries.'],
        ['Opacity / state', 'planned', 'Hover / pressed / disabled / selected.'],
      ]},
    ],
  },
  {
    ...
    groups: [
      { label: 'Structure & surface', items: [
        ...
        ['Divider', 'planned', 'Horizontal or vertical rule.', 'divider'],
        ['Box / Frame', 'planned', 'Generic styled container.'],
        ['Aspect ratio box', 'planned', 'Locks a child to a ratio.'],
        ['Scrim', 'planned', 'Dimming layer behind overlays.'],
      ]},
      { label: 'Typography & content', items: [
        ['Text', 'built', 'Body / label / caption text variants.', 'text'],
        ['Heading', 'planned', 'Semantic h1–h6 on the type scale.'],
        ['Link', 'planned', 'Inline navigational text.', 'link'],
        ['Code', 'planned', 'Monospace inline code.'],
        ['Kbd', 'planned', 'Keyboard key glyph.'],
        ['Truncate', 'planned', 'Single / multi-line clamp.'],
      ]},
      { label: 'Indicators & status', items: [
        ['Icon', 'built', 'Masked SVG glyph from the registry.', 'icon'],
        ['Badge', 'planned', 'Small count or label overlay.', 'badge'],
        ['Tag / Chip', 'planned', 'Static labeled token.', 'tag'],
        ['Spinner', 'planned', 'Indeterminate circular loader.', 'spinner'],
        ['Progress (linear)', 'planned', 'Determinate bar.', 'progress'],
        ['Progress (ring)', 'planned', 'Determinate ring.', 'progressRing'],
        ['Skeleton', 'planned', 'Shimmer placeholder block.', 'skeleton'],
      ]},
      { label: 'Media & a11y', items: [
        ['Image', 'planned', 'Responsive image with fit/placeholder.', 'image'],
        ['Avatar', 'planned', 'User image / initials / fallback.', 'avatar'],
        ['VisuallyHidden', 'planned', 'Screen-reader-only content.'],
        ['Skip link', 'planned', '“Skip to content”.'],
      ]},
    ],
  },
  {
    ...
    groups: [
      { label: 'Buttons & actions', items: [
        ...
        ['Icon button', 'planned', 'Icon-only action.', 'iconButton'],
        ['FAB', 'planned', 'Floating action button.', 'fab'],
        ['Toggle button', 'planned', 'Pressable on/off button.'],
        ['Split button', 'planned', 'Primary action + menu caret.'],
        ['Close button', 'planned', 'Standardized dismiss.', 'closeButton'],
      ]},
      { label: 'Text entry', items: [
        ['Text input', 'planned', 'Single-line text.', 'input'],
        ['Textarea', 'planned', 'Multi-line, auto-grow.', 'textarea'],
        ['Search input', 'planned', 'Query field with clear.', 'search'],
        ['Number / Stepper', 'planned', 'Numeric with +/−.'],
        ['Password input', 'planned', 'Masked + reveal toggle.'],
        ['OTP input', 'planned', 'Segmented one-time code.', 'otp'],
        ['Tag input', 'planned', 'Free-form multi-value entry.'],
      ]},
      { label: 'Selection & toggles', items: [
        ['Checkbox', 'planned', 'Boolean, incl. indeterminate.', 'checkbox'],
        ['Radio', 'planned', 'Single choice in a group.', 'radio'],
        ['Switch', 'built', 'On/off — the kube switch.', 'toggle'],
        ['Slider', 'planned', 'Single-value range — the kube slider.', 'slider'],
        ['Segmented control', 'planned', 'Inline exclusive options.', 'segmented'],
        ['Rating', 'planned', 'Star / heart score input.', 'rating'],
        ['Select', 'planned', 'Native dropdown.'],
        ['File input', 'planned', 'Choose file(s).'],
      ]},
    ],
  },
  {
    ...
    groups: [
      { label: 'Forms', items: [
        ['Form field', 'planned', 'Label + control + help + error.', 'formField'],
        ['Combobox', 'planned', 'Input + filtered listbox.'],
        ['Autocomplete', 'planned', 'Typeahead suggestions.'],
        ['Radio group', 'planned', 'Set of radios.'],
        ['Input group', 'planned', 'Prefix / suffix addons.'],
      ]},
      { label: 'Navigation', items: [
        ['Tabs', 'planned', 'Tab list + panels.', 'tabs'],
        ['Breadcrumb', 'planned', 'Hierarchical trail.', 'breadcrumb'],
        ['Pagination', 'planned', 'Page navigation.', 'pagination'],
        ['Menu', 'planned', 'List of actionable items.', 'menu'],
        ['Dropdown menu', 'planned', 'Trigger + menu.'],
        ['Stepper', 'planned', 'Numbered step indicator.'],
      ]},
      { label: 'Disclosure & overlays', items: [
        ['Accordion', 'planned', 'Stacked expandable sections.', 'accordion'],
        ['Tooltip', 'planned', 'Hover / focus hint.', 'tooltip'],
        ['Popover', 'planned', 'Anchored floating panel.'],
        ['Tree', 'planned', 'Hierarchical expandable list.'],
      ]},
      { label: 'Feedback', items: [
        ['Alert', 'planned', 'Contextual success / warn / error.', 'alert'],
        ['Toast', 'planned', 'Transient notification.', 'toast'],
        ['Banner', 'planned', 'Page-level announcement.'],
        ['Empty state', 'planned', 'No-data placeholder + action.', 'emptyState'],
        ['Loading overlay', 'planned', 'Blocking spinner region.'],
      ]},
      { label: 'Data display', items: [
        ['Card', 'planned', 'Header / body / footer container.', 'card'],
        ['List', 'planned', 'Vertical itemized content.', 'list'],
        ['Stat / KPI', 'planned', 'Single number + delta.', 'stat'],
        ['Avatar group', 'planned', 'Stacked avatars + overflow.', 'avatarGroup'],
        ['Timeline', 'planned', 'Chronological events.', 'timeline'],
        ['Table (basic)', 'planned', 'Static rows / columns.', 'table'],
        ['Filter chips', 'planned', 'Toggleable filter tokens.', 'filterChips'],
      ]},
      { label: 'Composed', items: [
        ['Search bar', 'built', 'Glass search field + action.', 'search'],
        ['Button group', 'planned', 'Joined button set.'],
        ['Quantity selector', 'planned', '−/value/+ control.'],
        ['Media object', 'planned', 'Media + adjacent text.'],
      ]},
    ],
  },
  {
    ...
    groups: [
      { label: 'App chrome & navigation', items: [
        ['Navbar / App bar', 'planned', 'Top application bar.', 'navbar'],
        ['Sidebar nav', 'planned', 'Primary side navigation.', 'sidebarNav'],
        ['Toolbar', 'planned', 'Action / format strip.', 'toolbar'],
        ['Command palette', 'planned', 'Searchable command launcher.', 'commandPalette'],
        ['Page header', 'planned', 'Title + meta + actions.'],
        ['Footer', 'planned', 'Site / app footer link groups.'],
      ]},
      { label: 'Overlays & flows', items: [
        ['Modal / Dialog', 'planned', 'Centered focus-trapped overlay.', 'modal'],
        ['Drawer / Sheet', 'planned', 'Edge / bottom sliding panel.'],
        ['Notification center', 'planned', 'Inbox of notifications.'],
        ['Onboarding tour', 'planned', 'Coachmark sequence.'],
      ]},
      { label: 'Forms & data entry', items: [
        ['Form (full)', 'planned', 'Multi-section validated form.'],
        ['Wizard', 'planned', 'Stepped flow with progress.'],
        ['Login / Auth form', 'planned', 'Sign-in / up / reset.', 'authForm'],
        ['Date picker', 'planned', 'Calendar + input.', 'datePicker'],
        ['File uploader', 'planned', 'Drag-drop + progress list.', 'fileUploader'],
        ['Rich text editor', 'planned', 'WYSIWYG + toolbar.'],
        ['Settings panel', 'planned', 'Grouped preference controls.'],
      ]},
      { label: 'Data & dashboards', items: [
        ['Data table', 'planned', 'Sort / filter / select / paginate.', 'dataTable'],
        ['Data grid', 'planned', 'Virtualized editable grid.'],
        ['Chart card', 'planned', 'Titled chart + legend.'],
        ['Calendar / Scheduler', 'planned', 'Month / week / day views.'],
        ['Kanban board', 'planned', 'Columns of draggable cards.', 'kanban'],
        ['Faceted filter panel', 'planned', 'Filters + active chips.'],
      ]},
      { label: 'Communication & media', items: [
        ['Chat thread', 'planned', 'Message list + composer.', 'chatThread'],
        ['Comment thread', 'planned', 'Nested comments + reply.'],
        ['Media player', 'planned', 'Full audio / video player.', 'mediaPlayer'],
        ['Image gallery', 'planned', 'Grid + lightbox viewer.'],
        ['Carousel', 'planned', 'Swipeable slides + controls.'],
        ['User / Profile card', 'planned', 'Identity summary + actions.'],
      ]},
      { label: 'Commerce', items: [
        ['Product card', 'planned', 'Image + price + actions.', 'productCard'],
        ['Pricing table', 'planned', 'Tiered plan comparison.', 'pricingTable'],
        ['Cart / Mini-cart', 'planned', 'Line items + totals.'],
        ['Checkout flow', 'planned', 'Address / payment / review.'],
      ]},
    ],
  },
  {
    ...
    groups: [
      { label: 'Structural primitives', items: [
        ['Stack (V/H)', 'planned', 'Even-spaced flow.', 'stack'],
        ['Grid', 'planned', 'Responsive N-column grid.', 'grid'],
        ['Cluster / Inline', 'planned', 'Wrapping inline group.'],
        ['Center', 'planned', 'Horizontally center + max-width.'],
        ['Sidebar layout', 'planned', 'Fixed side + fluid main.', 'splitView'],
        ['Container / Section', 'planned', 'Max-width content band.'],
      ]},
      { label: 'Application shells', items: [
        ['App shell', 'planned', 'Header + sidebar + content + footer.', 'appShell'],
        ['Dashboard layout', 'planned', 'Nav + widget grid.', 'dashboard'],
        ['Master–detail', 'planned', 'List + detail pane.', 'splitView'],
        ['Settings layout', 'planned', 'Section nav + panels.'],
        ['Three-column (feed)', 'planned', 'Nav + feed + aside.'],
      ]},
      { label: 'Page templates', items: [
        ['Auth page', 'planned', 'Centered card on backdrop.', 'authLayout'],
        ['Landing / Marketing', 'planned', 'Hero + sections + footer.', 'hero'],
        ['Hero section', 'planned', 'Headline + CTA + media.', 'hero'],
        ['Pricing page', 'planned', 'Plans + FAQ.'],
        ['Docs page', 'planned', 'Sidebar + prose + on-this-page.'],
        ['Empty / Error / 404', 'planned', 'Status pages.'],
      ]},
    ],
  },
];
